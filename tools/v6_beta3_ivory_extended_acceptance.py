...
import v6_beta3_ivory_acceptance as base
...
def main():
    global ROOT
    ap=argparse.ArgumentParser();ap.add_argument('--chromium',default='/usr/bin/chromium');ap.add_argument('--app-root',default=str(ROOT));ap.add_argument('--json-out',default='reports/v6-beta3-ivory-extended-acceptance.json');a=ap.parse_args();ROOT=Path(a.app_root).resolve();base.ROOT=ROOT
