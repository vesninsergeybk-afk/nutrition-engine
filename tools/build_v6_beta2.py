...
BASE='v6.0.0-beta1-profile-continuity'
CREATED='2026-08-05T11:30:00Z'
FIXED_DT=(2026,8,5,11,30,0)
...
EXCLUDE_NAMES={'release-manifest.json','release-sbom.spdx.json','reports/v6-beta2-build.json','reports/v6-beta2-archive-verification.json'}
HOSTING_DOCS=[
 'config/runtime-assets.v6.0.0-beta2.json','README_DEPLOY_V6_BETA2_RU.md',
 'NUTRITION_CALCULATOR_V6_0_0_BETA2_NUTRIENT_GROUP_OVERVIEW_RELEASE_NOTES_RU.md',
 'NUTRITION_CALCULATOR_V6_0_0_BETA2_NUTRIENT_GROUP_OVERVIEW_CHANGELOG_RU.md',
 'NUTRITION_CALCULATOR_V6_0_0_BETA2_NUTRIENT_GROUP_OVERVIEW_TEST_REPORT_RU.md',
 'NUTRITION_CALCULATOR_V6_0_0_BETA2_NUTRIENT_GROUP_OVERVIEW_AUDIT_RU.md',
 'NUTRITION_CALCULATOR_V6_0_0_BETA2_NUTRIENT_GROUP_OVERVIEW_FINAL_ACCEPTANCE_RU.md']
REQUIRED_REPORTS=[
 'reports/v6-beta2-release-audit.json','reports/v6-beta2-nutrient-group-acceptance.json',
 'reports/v6-beta2-profile-acceptance.json','reports/v6-beta2-analysis-continuity.json',
 'reports/v6-beta2-ivory-acceptance.json','reports/v6-beta2-ivory-extended-acceptance.json',
 'reports/v6-beta2-gemini-media-acceptance.json','reports/v6-beta2-syntax-checks.json',
 'reports/v6-beta2-runtime-inventory.json','reports/v6-beta2-protected-comparison.json',
 'reports/v6-beta2-generator-idempotency.json','reports/v6-beta2-ui-budget.json',
 'reports/v6-beta2-extracted-hosting-acceptance.json',
...
def manifest(kind,files):
 audit=read_json('reports/v6-beta2-release-audit.json');group=read_json('reports/v6-beta2-nutrient-group-acceptance.json');profile=read_json('reports/v6-beta2-profile-acceptance.json');analysis=read_json('reports/v6-beta2-analysis-continuity.json');ui=read_json('reports/v6-beta2-ivory-acceptance.json');ux=read_json('reports/v6-beta2-ivory-extended-acceptance.json');media=read_json('reports/v6-beta2-gemini-media-acceptance.json');runtime=read_json('reports/v6-beta2-runtime-inventory.json');protected=read_json('reports/v6-beta2-protected-comparison.json');budget=read_json('reports/v6-beta2-ui-budget.json');syntax=read_json('reports/v6-beta2-syntax-checks.json');http=read_json('reports/hf28-http-contract.json');secret_http=read_json('reports/hf28-packaged-secret-http.json');extracted=read_json('reports/v6-beta2-extracted-hosting-acceptance.json');live=read_json('reports/v6-live-audio-transport-probe.json')
 ...
 return {
  ...
  'change_scope':'Transparent nutrient-group navigation overview over the canonical detailed table; no new score and no calculation-engine changes.',
  'architecture':{
   ...
   'future_work':{'HOTFIX29':'unified interaction states','HOTFIX30':'final profile progressive disclosure'},
  ...
  'acceptance':{
   'release_audit':{'ok':audit['ok'],'assertions':audit['assertions']},'group_overview':{'ok':group['ok'],'assertions':group['assertions']},
  ...
  'limitations':[
   ...
   'Human usability testing has not yet been performed; release status remains beta 2.',
   ...
   'HOTFIX29 and HOTFIX30 remain separate planned stages and are not claimed as completed in this release.'],
  'files':rows}
def spdx(name,files):
 fs=[]
...
def main():
 ...
 r=subprocess.run([sys.executable,str(ROOT/'tools/generate_v6_beta2_runtime.py')],cwd=ROOT,env=env,capture_output=True,text=True)
 ...
 (ROOT/'reports/v6-beta2-build.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8');print(json.dumps(result,ensure_ascii=False,indent=2))
