...
BASE='v6.0.0-beta4-profile-hierarchy'
CREATED='2026-08-05T14:30:00Z'
FIXED_DT=(2026,8,5,14,30,0)
...
EXCLUDE_NAMES={'release-manifest.json','release-sbom.spdx.json','reports/v6-beta5-build.json','reports/v6-beta5-archive-verification.json'}
PREFIX='NUTRITION_CALCULATOR_V6_0_0_BETA5_CROSS_STAGE_HARDENING'
HOSTING_DOCS=[
 'config/runtime-assets.v6.0.0-beta5.json','README_DEPLOY_V6_BETA5_RU.md',
...
REQUIRED_REPORTS=[
 'reports/v6-beta5-release-audit.json','reports/v6-beta5-profile-hierarchy-acceptance.json','reports/v6-beta5-profile-acceptance.json',
 'reports/v6-beta5-interaction-acceptance.json','reports/v6-beta5-nutrient-group-acceptance.json','reports/v6-beta5-analysis-continuity.json',
 'reports/v6-beta5-ivory-acceptance.json','reports/v6-beta5-ivory-extended-acceptance.json','reports/v6-beta5-gemini-media-acceptance.json',
 'reports/v6-beta5-syntax-checks.json','reports/v6-beta5-runtime-inventory.json','reports/v6-beta5-protected-comparison.json',
 'reports/v6-beta5-generator-idempotency.json','reports/v6-beta5-ui-budget.json','reports/v6-beta5-extracted-hosting-acceptance.json',
...
def manifest(kind,files):
 names={
  'audit':'reports/v6-beta5-release-audit.json','hierarchy':'reports/v6-beta5-profile-hierarchy-acceptance.json','profile':'reports/v6-beta5-profile-acceptance.json',
  'interaction':'reports/v6-beta5-interaction-acceptance.json','group':'reports/v6-beta5-nutrient-group-acceptance.json','analysis':'reports/v6-beta5-analysis-continuity.json',
  'ui':'reports/v6-beta5-ivory-acceptance.json','ux':'reports/v6-beta5-ivory-extended-acceptance.json','media':'reports/v6-beta5-gemini-media-acceptance.json',
  'runtime':'reports/v6-beta5-runtime-inventory.json','protected':'reports/v6-beta5-protected-comparison.json','budget':'reports/v6-beta5-ui-budget.json',
  'syntax':'reports/v6-beta5-syntax-checks.json','http':'reports/hf28-http-contract.json','secret_http':'reports/hf28-packaged-secret-http.json',
 ...
 return {
  ...
  'change_scope':'Cross-stage hardening of HOTFIX28–30: profile-first viewport, coherent release metadata, retained Gemini reliability and complete analytics; no calculation-engine changes.',
  'architecture':{
   ...
   'view_model_contract':'NutritionUIViewModel.v1','profile_hierarchy_contract':'NutritionProfileHierarchyV2','profile_hierarchy_release':'HOTFIX30 completed and re-audited',
   ...
   'canonical_calculation_button':'needs_calc_btn','primary_profile_action':'profileCalculateContinue','stable_profile_dom_after_startup':True,'required_fields_first_actionable_content':True,'profile_route_hides_unrelated_analytics':True,
  ...
  'limitations':[
   ...
   'Human usability testing has not yet been performed; release status remains beta 5.',
   ...
   'HOTFIX28, HOTFIX29 and HOTFIX30 were re-audited together; later work should focus on live-device acceptance and release-candidate hardening.'],
  'files':rows}
def spdx(name,files):
 fs=[]
...
def main():
 ...
 r=subprocess.run([sys.executable,str(ROOT/'tools/generate_v6_beta5_runtime.py')],cwd=ROOT,env=env,capture_output=True,text=True)
 ...
 (ROOT/'reports/v6-beta5-build.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8');print(json.dumps(result,ensure_ascii=False,indent=2))
