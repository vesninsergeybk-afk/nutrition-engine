...
async def delayed_case(browser):
    ...
    started,shell,requests,bytes_getter=await install_app(page,delays={'products.v5.3.210-p1.3.bundle.js':2.5,'deferred-runtime-v5.3.210-rc2-hf23.js':2.5})
...
async def fallback_case(browser,kind):
    suffixes={
      'critical':'critical-shell-v5.3.210-rc2-hf23.js',
      'product':'products.v5.3.210-p1.3.bundle.js',
      'runtime':'deferred-runtime-v5.3.210-rc2-hf23.js'
    }
    ctx,page,errors=await new_page(browser,(390,844))
