...
DEFAULT_BASE = Path('/mnt/data/nutrition_v6_beta3_interaction_work')
...
def main():
    global ROOT
    ap=argparse.ArgumentParser(); ap.add_argument('--app-root',default=str(ROOT)); ap.add_argument('--base-root',default=str(DEFAULT_BASE)); ap.add_argument('--json-out',default='reports/v6-beta4-protected-comparison.json'); ns=ap.parse_args()
