...
(function(w,d){
  ...
  var ROUTES={
    ...
    correction:{
      ...
      eyebrow:'Коррекция',
      description:'Сначала — приоритетные отклонения и один проверяемый шаг, затем — полный пересчёт выбранного варианта.',
  ...
  var WORKSPACE_HIDDEN_IDS=['rc1BetaSupport','geminiAiSection'];
  ...
  var TARGET_ROUTE={
    ...
    workspaceCorrectionPanel:'correction',workspaceCorrectionPriorities:'correction',workspaceCorrectionPreview:'correction',heiLevers:'correction',heiRecs:'correction',geminiAiSection:'correction',
  ...
  function createShell(){
    ...
    context.innerHTML='<div class="navigation-shell-context__copy"><span id="navigationShellEyebrow"></span><h2 id="navigationShellTitle" tabindex="-1"></h2><p id="navigationShellDescription"></p></div>'+
      ...
      '<div class="navigation-shell-context__links" id="navigationShellCorrectionLinks" hidden><button type="button" data-navshell-jump="workspaceCorrectionPriorities">Приоритеты</button><button type="button" data-navshell-jump="workspaceCorrectionPreview">Предпросмотр</button></div>'+
