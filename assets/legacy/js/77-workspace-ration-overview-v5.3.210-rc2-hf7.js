...
(function(w,d){
  ...
  var VERSION='v5.3.210-rc2-hf7-workspace-slice';
  ...
  function init(){
    ...
    w.NutritionWorkspaceSliceHF7={version:VERSION,refresh:refresh,getSummary:function(){var kpi=parseKpi(),a=w.__lastDietAssessment||{};return {version:VERSION,route:route(),workspace:workspace(),items:kpi.count,kcal:kpi.kcal,hei:a.hei&&a.hei.total,limitations:(a.limitations||[]).length};}};
