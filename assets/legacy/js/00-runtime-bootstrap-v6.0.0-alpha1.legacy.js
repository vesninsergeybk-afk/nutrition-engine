...
(function(){
  'use strict';
  var RELEASE_GATE_VERSION = 'v6.0.0-alpha1-ivory-brass';
  var VERSION = 'v6_0_0_alpha1_ivory_brass';
  ...
  // v6 alpha 1: the splash follows the real full-start pipeline instead of closing at shell-ready.
