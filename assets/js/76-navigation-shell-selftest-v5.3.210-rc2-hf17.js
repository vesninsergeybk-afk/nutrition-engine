/* Stage 5A stability navigation shell deterministic runtime self-test. */
(function(w,d){'use strict';
var VERSION='v5.3.210-rc2-hf17-navigation-shell-selftest';
function run(){
 ...
 ok('apiLoaded',!!api);ok('version',!!api&&api.version==='v5.3.210-rc2-hf17');
 ...
 ok('fivePrimaryDestinations',d.querySelectorAll('#navigationShell .navigation-shell__items [data-navshell-route]').length===5);
 ...
 ok('idempotentVisibilityController',!!api&&api.version==='v5.3.210-rc2-hf17');
