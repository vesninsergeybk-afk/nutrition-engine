...
var RELEASE_VERSION='v5.3.210-rc2-hf27-microphone-resilience';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v5.3.210-hf27.legacy.js?v=v5.3.210-rc2-hf27-microphone-resilience');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v5.3.210-hf27.js?v=v5.3.210-rc2-hf27-microphone-resilience');
})(window,document);
