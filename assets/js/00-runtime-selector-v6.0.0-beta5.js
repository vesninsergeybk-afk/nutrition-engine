...
var RELEASE_VERSION='v6.0.0-beta5-cross-stage-hardening';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v6.0.0-beta5.legacy.js?v=v6.0.0-beta5-cross-stage-hardening');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v6.0.0-beta5.js?v=v6.0.0-beta5-cross-stage-hardening');
})(window,document);
