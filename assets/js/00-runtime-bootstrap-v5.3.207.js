...
(function(){
  'use strict';
  var VERSION = 'v5.3.207_comprehensive_nutrient_scenario_pass_3';
  ...
  var CORE_SCRIPTS = [
    ...
    "./assets/js/03-app-core-v5.3.207.js?v=5.3.207",
    "./assets/js/66-ration-state-recovery-v5.3.207.js?v=5.3.207",
    "./assets/js/04-needs-norms.js?v=5.3.155",
    "./assets/js/05-hei-bridges.js?v=v5.3.138",
    "./assets/js/06-dialogs-export-print-v5.3.207.js?v=5.3.207",
    "./assets/js/08-ux-search-mobile-v5.3.207.js?v=5.3.207",
    "./assets/js/53-ration-clarity-analytics-v5.js?v=v5.3.138",
    "./assets/js/10-ui-polish-v5.3.207.js?v=5.3.207",
    ...
    "./assets/js/61-ai-nutrition-planner-v5.3.207.js?v=5.3.207",
