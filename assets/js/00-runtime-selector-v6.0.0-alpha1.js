/* v6.0.0 alpha 1 — ES5-safe runtime selector */
(function(w,d){'use strict';
var RELEASE_VERSION='v6.0.0-alpha1-ivory-brass';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v6.0.0-alpha1.legacy.js?v=v6.0.0-alpha1-ivory-brass');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v6.0.0-alpha1.js?v=v6.0.0-alpha1-ivory-brass');
})(window,document);
