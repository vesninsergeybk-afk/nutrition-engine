/* Nutrition Calculator v6 beta 5 — HOTFIX30 final profile hierarchy.
...
(function(w,d){
  'use strict';
  var VERSION='v6.0.0-beta5-cross-stage-hardening';
  ...
  function createStructure(){
    ...
    var continuity=byId('profileContinuityPanel');if(continuity){continuity.classList.add('profile-continuity--embedded');appendUnique(basic,continuity);}
    ...
    createMethodDisclosure(needs);var method=byId('profileMethodDetails');if(method&&utilities)root.insertBefore(method,utilities);updateSummary();return true;
  }
