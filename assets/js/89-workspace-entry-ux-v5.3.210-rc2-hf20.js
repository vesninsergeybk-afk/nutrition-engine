/* Nutrition Calculator v5.3.210 RC2 HF20
...
(function(w,d){
  ...
  var VERSION='v5.3.210-rc2-hf20-entry-ux';
  ...
  function createRationEntryMethods(){
    ...
    panel.innerHTML=''+
      '<div class="workspace-ration-entry-methods__copy"><span>Добавление продуктов</span><strong id="workspaceRationEntryMethodsTitle">Поиск или ИИ-распознавание</strong><small>ИИ может распознать продукты по фотографии, голосу или готовому аудиофайлу.</small></div>'+
  ...
  function handleEntryMethod(kind){
    ...
    /* Keep the browser action inside the originating user gesture so file and
       microphone prompts are not blocked as synthetic delayed actions. */
  ...
  function init(){
    ...
    w.NutritionWorkspaceEntryUXHF20={version:VERSION,refresh:sync,goToProfile:goToProfile,setMode:setMode,revealAiSection:revealAiSection};
