/* v5.3.210 — ES5-safe modern/legacy runtime selector with unique asset filenames */
(function(w,d){'use strict';
var RELEASE_VERSION='v5.3.210-rc2-hf25-splash-balance';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v5.3.210.legacy.js?v=v5.3.210-rc2-hf25-splash-balance');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v5.3.210.js?v=v5.3.210-rc2-hf25-splash-balance');
})(window,document);
