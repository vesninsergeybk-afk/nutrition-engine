...
(function(){
  'use strict';
  var VERSION = 'v5.3.190_preparation_final_cross_chain_pass5';
  ...
  var CORE_SCRIPTS = [
    ...
    "./assets/js/01-hei-module.js?v=v5.3.138",
    "./assets/js/03-app-core.js?v=v5.3.190",
    ...
    "./assets/js/39-hei-recompute-watchdog-v5.js?v=v5.3.138",
    ...
    "./assets/js/56-hei-recommendations-critical-pass-v5.js?v=v5.3.138",
    "./assets/js/57-hei-recommendations-personalization-pass-v5.js?v=v5.3.138",
    ...
    "./assets/js/61-gemini-ai-explanation-v5.js?v=v5.3.140",
    "./assets/js/62-gemini-ration-import-v5.js?v=v5.3.188",
  ...
  function loadProductChunks(urls, label){
    ...
    return Promise.all(urls.map(function(url){
      ...
      return { payload: { schema_version:'chunked-json-v1', app_version:'v5.3.190', products_count:products.length, chunk_urls:urls.slice() }, products: products };
    });
  }
  ...
  function loadProductScriptChunks(urls, label){
    ...
    return urls.reduce(function(promise, url, index){
      ...
      return { payload: { schema_version:'script-chunks-v1', app_version:'v5.3.190', products_count:products.length, chunk_urls:urls.slice() }, products: products };
    });
  }
  function loadEmbeddedProducts(errors){
    ...
    return { payload: Array.isArray(parsed) ? { app_version:'v5.3.190', products_count:products.length } : parsed, products: products };
  }
