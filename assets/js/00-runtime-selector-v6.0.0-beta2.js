...
var RELEASE_VERSION='v6.0.0-beta2-nutrient-group-overview';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v6.0.0-beta2.legacy.js?v=v6.0.0-beta2-nutrient-group-overview');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v6.0.0-beta2.js?v=v6.0.0-beta2-nutrient-group-overview');
})(window,document);
