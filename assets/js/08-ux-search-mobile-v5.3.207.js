...
(function(){
  ...
  function showToast(text){ const t=document.getElementById('searchAddedToast'); if(!t) return; t.textContent=text; t.classList.add('show'); clearTimeout(t.__timer); t.__timer=setTimeout(()=>t.classList.remove('show'),2400); }
