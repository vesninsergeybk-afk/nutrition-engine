...
(function(){
  'use strict';
  var VERSION = 'v5.3.209_product_ui_dom_ready_recovery';
  ...
  var CORE_SCRIPTS = [
    ...
    "./assets/js/01-hei-module.js?v=5.3.209",
    "./assets/js/03-app-core-v5.3.208.js?v=5.3.209",
    "./assets/js/66-ration-state-recovery-v5.3.207.js?v=5.3.209",
    "./assets/js/04-needs-norms.js?v=5.3.155",
    "./assets/js/05-hei-bridges.js?v=5.3.209",
    "./assets/js/06-dialogs-export-print-v5.3.207.js?v=5.3.209",
    "./assets/js/08-ux-search-mobile-v5.3.207.js?v=5.3.209",
    "./assets/js/53-ration-clarity-analytics-v5.js?v=v5.3.138",
    "./assets/js/10-ui-polish-v5.3.207.js?v=5.3.209",
    ...
    "./assets/js/19-serving-units.js?v=5.3.209",
    "./assets/js/23-mobile-ration-cards.js?v=v5.3.138",
    "./assets/js/24-unit-quick-input.js?v=5.3.209",
    ...
    "./assets/js/46-harvard-event-scroll-hardlock-v5.js?v=5.3.209",
    ...
    "./assets/js/50-integrated-diet-analysis-profile-v5.js?v=5.3.209",
    ...
    "./assets/js/55-design-system-audit-v5.js?v=5.3.209",
    "./assets/js/56-hei-recommendations-critical-pass-v5.js?v=5.3.209",
    "./assets/js/57-hei-recommendations-personalization-pass-v5.js?v=5.3.209",
    "./assets/js/58-hei-recommendations-language-polish-v5.js?v=5.3.209",
    "./assets/js/59-ui-ux-consolidation-v5.js?v=5.3.209",
    "./assets/js/60-norm-region-clarity-v5.js?v=v5.3.138",
    "./assets/js/61-ai-nutrition-planner-v5.3.206.js?v=5.3.209",
