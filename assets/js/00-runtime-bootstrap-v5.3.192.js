...
(function(){
  'use strict';
  var VERSION = 'v5.3.192_browser_compatibility_pass2';
  ...
  function loadProductChunks(urls, label){
    ...
    return Promise.all(urls.map(function(url){
      ...
      return { payload: { schema_version:'chunked-json-v1', app_version:'v5.3.192', products_count:products.length, chunk_urls:urls.slice() }, products: products };
    });
  }
  ...
  function loadProductScriptChunks(urls, label){
    ...
    return urls.reduce(function(promise, url, index){
      ...
      return { payload: { schema_version:'script-chunks-v1', app_version:'v5.3.192', products_count:products.length, chunk_urls:urls.slice() }, products: products };
    });
  }
  function loadEmbeddedProducts(errors){
    ...
    return { payload: Array.isArray(parsed) ? { app_version:'v5.3.192', products_count:products.length } : parsed, products: products };
  }
