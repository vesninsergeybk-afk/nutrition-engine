...
var RELEASE_VERSION='v6.0.0-beta7-navigation-recovery';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v6.0.0-beta7.legacy.js?v=v6.0.0-beta7-navigation-recovery');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v6.0.0-beta7.js?v=v6.0.0-beta7-navigation-recovery');
})(window,document);
