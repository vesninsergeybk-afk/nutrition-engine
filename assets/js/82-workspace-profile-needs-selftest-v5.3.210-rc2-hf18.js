/* HF18 stable profile-first workspace static/browser self-test. */
(function(w,d){'use strict';
  ...
  function run(){
    ...
    return {ok:errors.length===0,version:'v5.3.210-rc2-hf18',errors:errors,route:nav&&nav.getState?nav.getState().route:null,ready:api&&api.isReady?api.isReady():false};
  }
  w.WorkspaceProfileNeedsSelftestHF18={run:run};
