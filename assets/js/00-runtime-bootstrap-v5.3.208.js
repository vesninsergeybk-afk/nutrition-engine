...
(function(){
  'use strict';
  var VERSION = 'v5.3.208_desktop_render_stability_pass';
  ...
  var CORE_SCRIPTS = [
    ...
    "./assets/js/01-hei-module.js?v=5.3.208",
    "./assets/js/03-app-core-v5.3.208.js?v=5.3.208",
    "./assets/js/66-ration-state-recovery-v5.3.207.js?v=5.3.208",
    "./assets/js/04-needs-norms.js?v=5.3.155",
    "./assets/js/05-hei-bridges.js?v=5.3.208",
    "./assets/js/06-dialogs-export-print-v5.3.207.js?v=5.3.208",
    "./assets/js/08-ux-search-mobile-v5.3.207.js?v=5.3.208",
    "./assets/js/53-ration-clarity-analytics-v5.js?v=v5.3.138",
    "./assets/js/10-ui-polish-v5.3.207.js?v=5.3.208",
    ...
    "./assets/js/19-serving-units.js?v=5.3.208",
    "./assets/js/23-mobile-ration-cards.js?v=v5.3.138",
    "./assets/js/24-unit-quick-input.js?v=5.3.208",
    ...
    "./assets/js/43-harvard-whatif-simulator-v5.js?v=v5.3.199",
    "./assets/js/44-harvard-apply-plan-v5.js?v=v5.3.138",
    "./assets/js/45-interaction-state-guard-v5.js?v=v5.3.138",
    "./assets/js/46-harvard-event-scroll-hardlock-v5.js?v=5.3.208",
    ...
    "./assets/js/50-integrated-diet-analysis-profile-v5.js?v=5.3.208",
    ...
    "./assets/js/55-design-system-audit-v5.js?v=5.3.208",
    "./assets/js/56-hei-recommendations-critical-pass-v5.js?v=5.3.208",
    "./assets/js/57-hei-recommendations-personalization-pass-v5.js?v=5.3.208",
    "./assets/js/58-hei-recommendations-language-polish-v5.js?v=5.3.208",
    "./assets/js/59-ui-ux-consolidation-v5.js?v=5.3.208",
    "./assets/js/60-norm-region-clarity-v5.js?v=v5.3.138",
    "./assets/js/61-ai-nutrition-planner-v5.3.206.js?v=5.3.208",
    ...
    function patchedAdd(target, nativeAdd){
      return function(type, listener, options){
        if (type === 'DOMContentLoaded' && listener && (domReadyFired || document.readyState === 'complete')) {
          ...
          if (options && options.once === true) return;
        }
  ...
  function loadScriptsOrderedParallelSafe(list){
    ...
    return new Promise(function(resolve){
      ...
      function done(src, ok, err){
        results.push(src);
        if (!ok) {
          try { console.warn('[v5.3.37 bootstrap] optional script failed', src, err && (err.message || err)); } catch(_) {}
        }
        remaining -= 1;
        if (LOADER_PROGRESS.scriptsTotal) setScriptProgress(LOADER_PROGRESS.scriptsDone + 1, LOADER_PROGRESS.scriptsTotal);
  ...
  function loadRuntime(){
    ...
    var critical = CORE_SCRIPTS.slice(0, 4); // preparation guard + HEI + app core + ration recovery
    var optional = CORE_SCRIPTS.slice(4);
    if (SELFTEST || DEV) optional = optional.concat(SELFTEST_SCRIPTS);
    if (DEV && (qs.get('legacytests') === '1' || qs.get('dev') === 'legacy')) optional = optional.concat(LEGACY_TEST_SCRIPTS);
    if (PERF) optional.push(PERF_SCRIPT);
