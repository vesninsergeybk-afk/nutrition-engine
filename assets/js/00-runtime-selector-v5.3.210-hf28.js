...
var RELEASE_VERSION='v5.3.210-rc2-hf28-gemini-reliability';
...
if(c.mode==='legacy'){
 load('./assets/legacy/compat-polyfills-v5.3.192.js?v=5.3.192',function(){
  load('./assets/legacy/compat-runtime-bridge-v5.3.192.js?v=5.3.192',function(){
   load('./assets/legacy/js/00-runtime-bootstrap-v5.3.210-hf28.legacy.js?v=v5.3.210-rc2-hf28-gemini-reliability');
  });
 });
}else load('./assets/js/00-runtime-bootstrap-v5.3.210-hf28.js?v=v5.3.210-rc2-hf28-gemini-reliability');
})(window,document);
