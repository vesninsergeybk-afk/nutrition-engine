/* HF27 legacy critical shell bundle; generated, calculation-neutral. */
...
/* BEGIN assets/js/90-media-entry-resilient-bridge-v5.3.210-rc2-hf27.js */
...
/* END assets/js/90-media-entry-resilient-bridge-v5.3.210-rc2-hf27.js */

/* BEGIN assets/legacy/js/89-workspace-entry-ux-v5.3.210-rc2-hf27.js */
/* Nutrition Calculator v5.3.210 RC2 HF27
...
(function(w,d){
  ...
  function init(){
    ...
    w.NutritionWorkspaceEntryUXHF27={version:VERSION,refresh:sync,goToProfile:goToProfile,setMode:setMode,revealAiSection:revealAiSection};
    try{w.dispatchEvent(new CustomEvent('workspace-entry-ux:ready',{detail:{version:VERSION}}));}catch(_){}
  }

  if(d.readyState==='loading')d.addEventListener('DOMContentLoaded',init,false);else init();
})(window,document);
/* END assets/legacy/js/89-workspace-entry-ux-v5.3.210-rc2-hf27.js */
