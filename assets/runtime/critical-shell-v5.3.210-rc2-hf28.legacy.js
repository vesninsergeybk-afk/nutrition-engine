/* HF28 legacy critical shell bundle; generated, calculation-neutral. */
...
(function(w,d){
  ...
  function startVoice(){
    if(voicePending){setDirectRecordState('working','Ожидаем разрешение…');setEntryStatus('Ожидаем ответ браузера на запрос микрофона. Если окно разрешения не появилось, откройте системный диктофон.','working',true);return false;}
...
/* BEGIN assets/legacy/js/89-workspace-entry-ux-v5.3.210-rc2-hf28.js */
/* Nutrition Calculator v5.3.210 RC2 HF28
...
/* END assets/legacy/js/89-workspace-entry-ux-v5.3.210-rc2-hf28.js */
